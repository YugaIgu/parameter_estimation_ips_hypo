These are the codes to reproduce the numerical results in the paper (preprint) "Parameter Estimation for Weakly Interacting Hypoelliptic Diffusions" written by Y. Iguchi, A. Beskos and G. A. Pavliotis. 
